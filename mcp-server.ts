...
server.tool(
  ...
  "Publish an interactive report to the BriefMe dashboard and wait for the user's response. Use this instead of writing long text responses. The tool blocks until the user makes their decisions and clicks Respond.",
  {
    ...
    sections: z.array(z.object({
      type: z.enum(["table", "card", "info", "code", "diff", "markdown", "jsx", "decision", "tabs", "accordion", "progress", "mermaid", "steps"]).describe("Section type"),
      ...
      content: z.string().optional().describe("Content (for markdown, jsx, card, info, code, diff, mermaid)"),
